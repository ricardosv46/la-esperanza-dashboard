...
const EventoId = () => {
  ...
  const {
    ...
    loading,
    refetch
  } = useButacasEvento({ tendido: selectValue, eventoId: evento?.eventoId })
          ...
          <Flex
            ...
            {dataAsientos?.length && selectValue?.length > 0 && (
              <Asientos
                ...
                doble={
                  selectValue === 'T2S' ? 'Tendido2' : selectValue === 'T3' ? 'Tendido3' : 'Ruedo'
                }
                direccion={
                  selectValue === 'T3A' ? 'end' : selectValue === 'T3B' ? 'start' : 'center'
                }
                id={selectValue}
              />
            )}
