...
const LoginPage = () => {
  ...
  return (
    <Flex w='100%' justifyContent='space-between' h='100vh'>
      <Flex pt={{ base: 16, md: 0 }} flex={1} h='full' justifyContent='center' alignItems={{ md: 'center' }}>
        <Box width={{ base: '90%', md: 96 }}>
          ...
          <Flex py={10} gap={10} as='form' autoComplete='none' flexDirection='column' onSubmit={handleSubmit}>
            <InputFloat
              type='email'
              label='Email'
              name='email'
      ...
      <Box flex={1} h='full' overflow='hidden' position='relative' display={{ base: 'none', md: 'block' }}>
        <Image w='full' h='full' inset={0} src={ImgLogin} pos='absolute' objectFit='cover' />

        <Box bg='#0E1C3A' pos='absolute' opacity='0.7' inset={0} />

        <Flex w='full' h='full' p={20} align='start' flexDir='column' justify='center' position='relative'>
