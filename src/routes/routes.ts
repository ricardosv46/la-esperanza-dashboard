...
const EditarPrecioButacas = lazy(
  () => import('../pages/home/precios/EditarPrecioButacas')
)
  ...
  },
  {
    ...
    subMenu: {
      ...
      paths: [
        ...
        {
          icon: IconOptions,
          name: 'Editar precio Butacas',
          path: 'editar-precio-butaca/:id',
          to: '/home/editar-precio-butaca',
          component: EditarPrecioButacas,
          render: false
        },
        {
          icon: IconFile,
